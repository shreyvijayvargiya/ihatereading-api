 ...
 * 1) Video URL (UploadThing) → download → base64 data URL for Gemini (OpenRouter requires this for non-YouTube).
 ...
 */
async function ttsSynthesizeToBuffer({ text, signal }) {
