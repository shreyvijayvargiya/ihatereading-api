...
export const DASHBOARD_TABLES = [
	...
	},
	{
		...
		description: "Y Combinator + a16z portfolio companies. Enrich stores site pages, logo/brand, llm.txt, address, lat/lng, mapsUrl.",
	},
	{
		id: "linkedin",
		label: "LinkedIn",
	...
	},
	{
		...
		description: "Business CRM products from Google search + list-page scrape. No LLM. Unique by website domain hash.",
	},
	{
		id: "influencers",
		label: "Influencers",
